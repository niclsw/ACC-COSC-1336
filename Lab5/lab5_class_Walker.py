...
#########################################
    def find_season(self):
        if self.contact_month == 1 or self.contact_month == 2 or self.contact_month == 12:
            season = 'Winter'
        elif self.contact_month == 3 or self.contact_month == 4 or self.contact_month == 5:
            season = 'Spring'
        elif self.contact_month == 6 or self.contact_month == 7 or self.contact_month == 8:
            season = 'Summer'
        else:
            season = 'Fall'
